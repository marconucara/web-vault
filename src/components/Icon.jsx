...
// names (icon/_icon of the type doc) that are not in this set, any valid lucide
// icon is resolved automatically (see below), so adding a new Type with a lucide
// `icon:` works without touching the code.
const LUCIDE_NAMES = new Set(iconNames);
...
const PATHS = {
  ...
  // Preferences, and the notice inside it. Local for the same reason as the
  // switch above: both sit in app chrome that has to paint with the first frame.
  settings: (
    <>
